...
class LocationService : Service() {
    ...
    private val safeZones = mutableListOf<com.simats.kidshield.models.SafeZone>()
    ...
    private fun createBreadcrumbLog(location: android.location.Location) {
        ...
        val event = com.simats.kidshield.models.TimelineEvent(
            childId = activeChildId,
        ...
        BackendManager.createTimelineEvent(event, object : BackendManager.ApiCallback<com.simats.kidshield.models.TimelineEvent> {
            override fun onSuccess(result: com.simats.kidshield.models.TimelineEvent) {
    ...
    private fun fetchSafeZones() {
        ...
        BackendManager.getSafeZones(activeChildId, object : BackendManager.ApiCallback<List<com.simats.kidshield.models.SafeZone>> {
            override fun onSuccess(result: List<com.simats.kidshield.models.SafeZone>) {
                safeZones.clear()
    ...
    private fun checkGeofences(location: android.location.Location) {
        ...
        for (zone in safeZones) {
            ...
            if (wasInside != isInsideNow) {
                ...
                val timelineEvent = com.simats.kidshield.models.TimelineEvent(
                    id = 0,
                    childId = activeChildId,
                ...
                BackendManager.createTimelineEvent(timelineEvent, object : BackendManager.ApiCallback<com.simats.kidshield.models.TimelineEvent> {
                    override fun onSuccess(result: com.simats.kidshield.models.TimelineEvent) {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        val session = com.simats.kidshield.utils.SessionManager.getInstance(this)
