...
import com.simats.kidshield.ParentMainActivity
...
class ParentAlertService : Service() {
    ...
    private fun pollAlerts(parentId: Int) {
        BackendManager.getChildren(parentId, object : BackendManager.ApiCallback<List<com.simats.kidshield.models.ChildProfile>> {
            override fun onSuccess(children: List<com.simats.kidshield.models.ChildProfile>) {
