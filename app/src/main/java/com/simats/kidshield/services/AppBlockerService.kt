...
class AppBlockerService : Service() {
    ...
    @Volatile private var cachedLimits: List<com.simats.kidshield.models.ScreenTimeLimitResponse> = emptyList()

    private fun fetchLimits() {
        BackendManager.getScreenTimeLimits(activeChildId, object : BackendManager.ApiCallback<List<com.simats.kidshield.models.ScreenTimeLimitResponse>> {
            override fun onSuccess(result: List<com.simats.kidshield.models.ScreenTimeLimitResponse>) {
                cachedLimits = result
