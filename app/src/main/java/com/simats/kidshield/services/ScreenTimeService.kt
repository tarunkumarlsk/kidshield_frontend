...
class ScreenTimeService : Service() {
    ...
    private fun uploadRealScreenUsage() {
        ...
        if (usageStats != null && usageStats.isNotEmpty()) {
            ...
            val usageList = mutableListOf<com.simats.kidshield.models.AppUsage>()
            for (entry in aggregatedMap) {
                ...
                if (usageTimeMinutes > 0) {
                    ...
                    usageList.add(com.simats.kidshield.models.AppUsage(displayLabel, usageTimeMinutes))
                }
            }
    ...
    private fun checkLimitsAndTriggerAlert(currentUsageMinutes: Int) {
        BackendManager.getScreenTimeLimits(childId, object : BackendManager.ApiCallback<List<com.simats.kidshield.models.ScreenTimeLimitResponse>> {
            override fun onSuccess(limits: List<com.simats.kidshield.models.ScreenTimeLimitResponse>) {
