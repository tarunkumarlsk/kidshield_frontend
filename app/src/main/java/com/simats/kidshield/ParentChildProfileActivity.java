...
import com.simats.kidshield.ai.AISafetyEngine;
...
public class ParentChildProfileActivity extends AppCompatActivity {
    ...
    private void calculateAndDisplayAIScore() {
        ...
        BackendManager.getScreenTimeLimits(childId, new BackendManager.ApiCallback<java.util.List<com.simats.kidshield.models.ScreenTimeLimitResponse>>() {
            @Override
            public void onSuccess(java.util.List<com.simats.kidshield.models.ScreenTimeLimitResponse> limits) {
                ...
                BackendManager.getScreenUsage(childId, new BackendManager.ApiCallback<java.util.List<com.simats.kidshield.models.ScreenUsageResponse>>() {
                    @Override
                    public void onSuccess(java.util.List<com.simats.kidshield.models.ScreenUsageResponse> usage) {
                        int totalUsage = 0;
                        int socialUsage = 0;
                        int eduUsage = 0;
                        for (com.simats.kidshield.models.ScreenUsageResponse u : usage) {
                        ...
                        // 3. Fetch Alerts
                        BackendManager.getAlerts(childId, new BackendManager.ApiCallback<java.util.List<com.simats.kidshield.models.AlertResponse>>() {
                            @Override
                            public void onSuccess(java.util.List<com.simats.kidshield.models.AlertResponse> alerts) {
                                int geofenceExits = 0;
                                int sosCount7d = 0;
    ...
    private void generateRelinkCode() {
        ...
        BackendManager.generatePairingCode(parentId, childId, new BackendManager.ApiCallback<com.simats.kidshield.models.PairingResponse>() {
            @Override
            public void onSuccess(com.simats.kidshield.models.PairingResponse result) {
                btn.setEnabled(true);
