...
import com.simats.kidshield.models.CheckChildResponse;
...
public class ChildLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.icon_container).setOnLongClickListener(v -> {
            ...
            com.simats.kidshield.utils.SessionManager sm =
                com.simats.kidshield.utils.SessionManager.getInstance(this);
            ...
            BackendManager.checkChildByCode(code, deviceId, deviceName,
                    new BackendManager.ApiCallback<CheckChildResponse>() {
                        ...
                        public void onSuccess(CheckChildResponse result) {
                            ...
                            com.simats.kidshield.utils.SessionManager sess =
                                    com.simats.kidshield.utils.SessionManager.getInstance(ChildLoginActivity.this);
