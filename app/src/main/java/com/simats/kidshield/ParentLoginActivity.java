...
public class ParentLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.logo_container).setOnLongClickListener(v -> {
            ...
            builder.setPositiveButton("Save", (dialog, which) -> {
                ...
                if (!newIp.isEmpty()) {
                    ...
                    com.simats.kidshield.network.RetrofitClient.INSTANCE.updateBaseUrl(newIp);
        ...
        btnSignIn.setOnClickListener(v -> {
            ...
            com.simats.kidshield.network.BackendManager.loginParent(email, password,
                    new com.simats.kidshield.network.BackendManager.ApiCallback<com.simats.kidshield.models.LoginResponse>() {
                        @Override
                        public void onSuccess(com.simats.kidshield.models.LoginResponse result) {
                            ...
                            com.simats.kidshield.utils.SessionManager session =
                                    com.simats.kidshield.utils.SessionManager.getInstance(ParentLoginActivity.this);
                            ...
                            com.simats.kidshield.network.BackendManager.getChildren(result.getUserId(),
                                    new com.simats.kidshield.network.BackendManager.ApiCallback<java.util.List<com.simats.kidshield.models.ChildProfile>>() {
                                        @Override
                                        public void onSuccess(java.util.List<com.simats.kidshield.models.ChildProfile> kids) {
                                            if (kids.isEmpty()) {
                                                // New parent with no kids setup
                                                startActivity(new Intent(ParentLoginActivity.this, AddNewDeviceActivity.class));
                                            } else {
                                                com.simats.kidshield.models.ChildProfile firstChild = kids.get(0);
                        ...
                        public void onError(String error) {
                            ...
                            if (error != null && (error.contains("failed to connect") || error.contains("Network error"))) {
                                String currentUrl = com.simats.kidshield.network.RetrofitClient.getBASE_URL_DIAGNOSTIC();
