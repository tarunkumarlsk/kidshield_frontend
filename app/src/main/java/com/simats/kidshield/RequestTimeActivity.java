...
public class RequestTimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_send).setOnClickListener(v -> {
            ...
            int childId = com.simats.kidshield.utils.SessionManager.getInstance(this).getChildId();
            if (childId == -1) {
                v.setEnabled(true);
            ...
            com.simats.kidshield.network.BackendManager.sendAlert(childId, "time_request", msg,
