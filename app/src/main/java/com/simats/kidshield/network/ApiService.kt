...
interface ApiService {
    ...
    ): Response<com.simats.kidshield.models.ChildProfile>
    ...
    suspend fun bulkUpdateScreenUsage(@Body request: com.simats.kidshield.models.BulkUsageRequest): Response<Any>
    ...
    @GET("children/")
    suspend fun getChildren(@Query("parent_id") parentId: Int): Response<List<com.simats.kidshield.models.ChildProfile>>

    @GET("children/{id}/")
    suspend fun getChildById(@Path("id") childId: Int): Response<com.simats.kidshield.models.ChildProfile>
    ...
    suspend fun syncInventory(@Body request: com.simats.kidshield.models.InventorySyncRequest): retrofit2.Response<Void>
