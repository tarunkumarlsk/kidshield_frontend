...
import com.simats.kidshield.TimeLimitsActivity;
import com.simats.kidshield.adapters.ChildCardAdapter;
...
public class DashboardFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        childAdapter.setOnChildClickListener(child -> {
            Intent intent = new Intent(requireContext(), com.simats.kidshield.ParentChildProfileActivity.class);
        ...
        view.findViewById(R.id.btn_add_child).setOnClickListener(v ->
                startActivity(new Intent(requireContext(), com.simats.kidshield.AddNewDeviceActivity.class)));
        ...
        view.findViewById(R.id.card_safe_zones).setOnClickListener(v ->
                startActivity(new Intent(requireContext(), com.simats.kidshield.SafeZonesActivity.class)));
