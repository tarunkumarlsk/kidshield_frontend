...
public class MapFragment extends Fragment {
    ...
    private List<com.example.kidshield.models.SafeZone> currentZones = new ArrayList<>();
    ...
    private void loadSafeZonesOnMap(int childId) {
        BackendManager.getSafeZones(childId, new BackendManager.ApiCallback<List<com.example.kidshield.models.SafeZone>>() {
            @Override
            public void onSuccess(List<com.example.kidshield.models.SafeZone> zones) {
                if (!isAdded()) return;
                currentZones = zones;
                ...
                for (com.example.kidshield.models.SafeZone zone : zones) {
