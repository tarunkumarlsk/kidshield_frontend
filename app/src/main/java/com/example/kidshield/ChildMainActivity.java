...
public class ChildMainActivity extends AppCompatActivity {
    ...
    private void startBackgroundServices() {
        try {
            startService(new android.content.Intent(this, com.example.kidshield.services.LocationService.class));
        } catch (Exception e) {
            android.util.Log.e("ChildMain", "Could not start LocationService: " + e.getMessage());
        }
        
        try {
            startService(new android.content.Intent(this, com.example.kidshield.services.ScreenTimeService.class));
        } catch (Exception e) {
            android.util.Log.e("ChildMain", "Could not start ScreenTimeService: " + e.getMessage());
        }

        try {
            startService(new android.content.Intent(this, com.example.kidshield.services.AppBlockerService.class));
        } catch (Exception e) {
